...
void loop() {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        fifoCount -= packetSize;
            ...
            SERIAL_OUT.print("quat\t");
            SERIAL_OUT.print(q.w);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.print(q.x);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.print(q.y);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.println(q.z);
        #endif
            ...
            SERIAL_OUT.print("euler\t");
            SERIAL_OUT.print(euler[0] * 180/M_PI);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.print(euler[1] * 180/M_PI);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.println(euler[2] * 180/M_PI);
        #endif
            ...
            SERIAL_OUT.print("ypr\t");
            SERIAL_OUT.print(ypr[0] * 180/M_PI);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.print(ypr[1] * 180/M_PI);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.println(ypr[2] * 180/M_PI);
        #endif
            ...
            SERIAL_OUT.print("areal\t");
            SERIAL_OUT.print(aaReal.x);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.print(aaReal.y);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.println(aaReal.z);
        #endif
            ...
            SERIAL_OUT.print("aworld\t");
            SERIAL_OUT.print(aaWorld.x);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.print(aaWorld.y);
            SERIAL_OUT.print("\t");
            SERIAL_OUT.println(aaWorld.z);
        #endif
            ...
            SERIAL_OUT.write(teapotPacket, 14);
